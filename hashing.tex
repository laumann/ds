...
\subsection*{TODO}
\begin{itemize}
	\item Restructure implementation code (clean up file, introduce header
		file etc., consider what should be supported)
	\item Move tests to separate implementation file (or folder). Consider
		GMP calculation for comparison.
\end{itemize}
